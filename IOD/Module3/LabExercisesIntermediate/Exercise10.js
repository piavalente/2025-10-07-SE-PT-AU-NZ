...
/* my birthday has not happened yet so it is reulting to a negative. THIS WAS EXTRA HARD WORK
...
console.log(
  `There are ${daysSinceBirthday} days between my birthday and today.`,
);
